      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-16">
          ...
          <div className="flex flex-col justify-center space-y-8">
            <a
              href="mailto:hello@biware.io"
              className="group flex items-center justify-between py-6 border-b border-border hover:border-primary transition-colors"
            >
              <span className="text-2xl md:text-3xl font-display">hello@biware.io</span>
            ...
            <a
              ...
              className="group flex items-center justify-between py-6 border-b border-border hover:border-primary transition-colors"
            >
              <span className="text-2xl md:text-3xl font-display">+1 234 567 890</span>
              <ArrowUpRight className="w-6 h-6 text-muted-foreground group-hover:text-primary group-hover:translate-x-1 group-hover:-translate-y-1 transition-all" />
            </a>
          </div>
        </div>
