...
const Hero = () => {
  return <section className="min-h-screen flex flex-col justify-center px-6 md:px-12 lg:px-24 relative">
      ...
      <a href="#about" className="absolute bottom-6 left-6 md:left-12 lg:left-24 flex items-center gap-3 text-muted-foreground hover:text-foreground transition-colors group">
